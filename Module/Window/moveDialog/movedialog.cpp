...
MoveDialog::MoveDialog(QWidget *parent) : MoveDialog(true, parent) { }

MoveDialog::MoveDialog(bool transparent, QWidget *parent)
    : QDialog(parent), _moveOption(false), _showShadow(true), _leftButtonPress(false) {
    // 删除标题栏
