...
namespace Chardet {
    ...
    CharConversion::CharConversion(QObject *parent) : QObject(parent) { }
    ...
    QString CharConversion::convertTradCharactersToSimplifiedCharacters(const QString &str) {
        QString tmpStr;
        foreach (auto c, str) { tmpStr += convertASingleTradCharToSimplifiedChar(c); }
        return tmpStr;
    }

    QString CharConversion::convertSimplifiedCharactersToTradCharacters(const QString &str) {
        QString tmpStr;
        foreach (auto c, str) { tmpStr += convertASingleSimplifiedCharToTradChar(c); }
        return tmpStr;
    }
    ...
    bool CharConversion::determineWhetherTheStrContainsChinese(const QString &str) {
        foreach (auto c, str) {
            if (determineWhetherACharIsAChineseChar(c)) return true;
        }
        return false;
    }
